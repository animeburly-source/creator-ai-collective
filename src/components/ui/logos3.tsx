  ...
  return (
    <section className="py-10">
      <div className="container mx-auto flex flex-col items-center text-center">
        <p className="text-sm font-semibold text-primary-foreground/60 uppercase tracking-[0.2em]">
          {heading}
        </p>
      </div>
      <div className="pt-6">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="mx-10 flex shrink-0 items-center justify-center">
                      <img
                        ...
                        className={`${logo.className} brightness-0 invert opacity-60 hover:opacity-100 transition-opacity duration-300`}
                      />
                    </div>
                  </div>
                </CarouselItem>
